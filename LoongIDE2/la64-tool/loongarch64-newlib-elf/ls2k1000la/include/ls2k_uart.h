...
#endif
#if (BSP_USE_UART10)
extern const void *devUART10;
#endif
#if (BSP_USE_UART11)
extern const void *devUART11;
#endif
...
#define IOCTL_NS16550_USE_IRQ       0x1001      // int: 0=disable, 1=enable
 ...
 * 返回:    0=成功
 */
int NS16550_init(const void *dev, void *arg);
 ...
 * 返回:    0=成功
 */
int NS16550_open(const void *dev, void *arg);
 ...
 * 返回:    0=成功
 */
int NS16550_close(const void *dev, void *arg);
 ...
 */
int NS16550_read(const void *dev, void *buf, int size, void *arg);
 ...
 */
int NS16550_write(const void *dev, void *buf, int size, void *arg);
 ...
 * 返回:    0=成功
 */
int NS16550_ioctl(const void *dev, int cmd, void *arg);
