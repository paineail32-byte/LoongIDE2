...
#ifndef LS2K_DRV_IO_H_
#define LS2K_DRV_IO_H_
...
typedef int (*I2C_rw_bytes_t)(const void *bus, unsigned char *txbuf, int txbytes,
                                               unsigned char *rxbuf, int rxbytes);
#endif
...
#if SUPPORT_SPI_DUAL_IO
typedef I2C_rw_bytes_t    SPI_rw_bytes_t;
#endif
