...
/*
 * LS2K300/LS2K301 使用传统中断时:
 *
 *  没有办法区分 DEVICE_RTCMATCH0~2、DEVICE_TOYMATCH0~2 是哪个发生了中断,
 *  所以只能各使用一个中断.
 *
 *  例如: 已经安装 DEVICE_RTCMATCH0的中断, 再安装 DEVICE_RTCMATCH1的中断,
 *        将不再响应DEVICE_RTCMATCH0的中断.
 *
 */
