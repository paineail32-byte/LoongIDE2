...
#define MCP4725_DEV_NAME        "i2c0.dac"
...
extern const driver_ops_t *mcp4725_drv_ops;

#define ls2k_mcp4725_write(iic, buf, size, arg) mcp4725_drv_ops->write_entry(iic, buf, size, arg)
#define ls2k_mcp4725_ioctl(iic, cmd, arg)       mcp4725_drv_ops->ioctl_entry(iic, cmd, arg)
 ...
 *  return 		0=successful
 */
int MCP4725_write(const void *bus, void *buf, int size, void *arg);
 ...
 *  return 		0=successful
 */
int MCP4725_ioctl(const void *bus, int cmd, void *arg);
 ...
 */
int set_mcp4725_dac(const void *bus, unsigned short dacVal);
