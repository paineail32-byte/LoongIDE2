 ...
 */
extern int ls2k301_gpio_interrupt_enable(int gpionum, int trigger_mode);

/*
 * 禁止GPIO中断
 * 参数:    gpio    gpio端口序号
 */
extern int ls2k301_gpio_interrupt_disable(int gpionum);
 ...
 */
extern int ls2k301_gpio_isr_install(int gpionum, void (*isr)(int, void *), void *arg);

/*
 * 取消已安装GPIO中断向量
 * 参数:    gpio    gpio端口序号
 */
extern int ls2k301_gpio_isr_remove(int gpionum);
