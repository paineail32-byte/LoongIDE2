...
C_SRCS += \
../ls2k300/drivers/watchdog/watchdog.c

OBJS += \
./ls2k300/drivers/watchdog/watchdog.o

C_DEPS += \
./ls2k300/drivers/watchdog/watchdog.d

# Each subdirectory must supply rules for building sources it contributes
ls2k300/drivers/watchdog/%.o: ../ls2k300/drivers/watchdog/%.c
	@echo 'Building file: $<'
