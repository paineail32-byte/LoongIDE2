...
C_SRCS += \
../ls2k300/drivers/i2c/mcp4725/mcp4725.c

OBJS += \
./ls2k300/drivers/i2c/mcp4725/mcp4725.o

C_DEPS += \
./ls2k300/drivers/i2c/mcp4725/mcp4725.d

# Each subdirectory must supply rules for building sources it contributes
ls2k300/drivers/i2c/mcp4725/%.o: ../ls2k300/drivers/i2c/mcp4725/%.c
	@echo 'Building file: $<'
