...
#define ADS1015_DEV_NAME        "i2c0.adc"
...
extern const driver_ops_t *ads1015_drv_ops;

#define ls2k_ads1015_read(iic, buf, size, arg)  ads1015_drv_ops->read_entry(iic, buf, size, arg)
#define ls2k_ads1015_ioctl(iic, cmd, arg)       ads1015_drv_ops->ioctl_entry(iic, cmd, arg)
 ...
 *  return 		0=successful
 */
int ADS1015_read(const void *bus, void *buf, int size, void *arg);
 ...
 *  return 		0=successful
 */
int ADS1015_ioctl(const void *bus, int cmd, void *arg);
