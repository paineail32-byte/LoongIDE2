...
#endif
#if BSP_USE_UART10
static struct rt_device rt_ls2k_uart10;
#endif
#if BSP_USE_UART11
static struct rt_device rt_ls2k_uart11;
#endif
...
#endif
#if BSP_USE_UART10
    rt_ls2k_uart_register(&rt_ls2k_uart10, devUART10, RT_DEVICE_FLAG_RDWR);
#endif
#if BSP_USE_UART11
    rt_ls2k_uart_register(&rt_ls2k_uart11, devUART11, RT_DEVICE_FLAG_RDWR);
#endif
}
