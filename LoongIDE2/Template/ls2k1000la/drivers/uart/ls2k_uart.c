...
static void NS16550_install_irq(NS16550_t *pUART)
{
    if ((pUART != NULL) && (pUART->irqVector > 0) && (pUART->bInterrupt))
    {
        ...
        ls2k_set_irq_routeip(pUART->irqVector, INT_ROUTE_IP2);
 ...
 */
#ifdef LS2K1000LA
static void ls2k1000_uart_init_io_base(NS16550_t *pUART);
#endif
...
STATIC_DRV int NS16550_init(const void *dev, void *arg)
{
    ...
    ls2k1000_uart_init_io_base(pUART);
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20000),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART0_3_IRQ,
    .initialized = 0,
    .opened      = 0,
    .dev_name    = "uart0",
};
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20100),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART0_3_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20200),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART0_3_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20300),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 1,
    .irqVector   = INTC0_UART0_3_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20400),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART4_7_IRQ,
    .initialized = 0,
    .opened      = 0,
    .dev_name    = "uart4",
};
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20500),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART4_7_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20600),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART4_7_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20700),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART4_7_IRQ,
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20800),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART8_11_IRQ,
    .initialized = 0,
    .opened      = 0,
    .dev_name    = "uart8",
};
...
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20900),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART8_11_IRQ,
...
/* UART 10 */
#if (BSP_USE_UART10)
static NS16550_t ls2k_UART10 =
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20a00),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART8_11_IRQ,
...
const void *devUART10 = &ls2k_UART10;
#endif

/* UART 11 */
#if (BSP_USE_UART11)
static NS16550_t ls2k_UART11 =
{
    .hwUART      = (HW_NS16550_t *)PHYS_TO_UNCACHED(0x1fe20b00),
    .BaudRate    = 115200,
    .bFlowCtrl   = 0,
    .bInterrupt  = 0,
    .irqVector   = INTC0_UART8_11_IRQ,
...
const void *devUART11 = &ls2k_UART11;
#endif

//-----------------------------------------------------------------------------
// Config UART IO address
//-----------------------------------------------------------------------------
...
#if (BSP_USE_UART0)
    if (pUART == &ls2k_UART0)
        ls2k_UART0.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0);
#endif
#if (BSP_USE_UART1)
    if (pUART == &ls2k_UART1)
        ls2k_UART1.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x100);
#endif
#if (BSP_USE_UART2)
    if (pUART == &ls2k_UART2)
        ls2k_UART2.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x200);
#endif
#if (BSP_USE_UART3)
    if (pUART == &ls2k_UART3)
        ls2k_UART3.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x300);
#endif
#if (BSP_USE_UART4)
    if (pUART == &ls2k_UART4)
        ls2k_UART4.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x400);
#endif
#if (BSP_USE_UART5)
    if (pUART == &ls2k_UART5)
        ls2k_UART5.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x500);
#endif
#if (BSP_USE_UART6)
    if (pUART == &ls2k_UART6)
        ls2k_UART6.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x600);
#endif
#if (BSP_USE_UART7)
    if (pUART == &ls2k_UART7)
        ls2k_UART7.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x700);
#endif
#if (BSP_USE_UART8)
    if (pUART == &ls2k_UART8)
        ls2k_UART8.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x800);
#endif
#if (BSP_USE_UART9)
    if (pUART == &ls2k_UART9)
        ls2k_UART9.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0x900);
#endif
#if (BSP_USE_UART10)
    if (pUART == &ls2k_UART10)
        ls2k_UART10.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0xa00);
#endif
#if (BSP_USE_UART11)
    if (pUART == &ls2k_UART11)
        ls2k_UART11.hwUART = (HW_NS16550_t *)PHYS_TO_UNCACHED(apb_address0 + 0xb00);
#endif
}
