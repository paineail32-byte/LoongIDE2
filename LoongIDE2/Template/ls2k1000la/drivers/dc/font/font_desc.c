...
#define IS_GB2312_CHAR(ch1, ch2) \
        (((ch1 >= 0xA1 && ch1 <= 0xA9) || (ch1 >= 0xB0 && ch1 <= 0xF7)) && ch2 >= 0xA1 && ch2 <= 0xFE)
...
/**********************************************************************
 * 西文字库 12x24点阵 operate functions
 **********************************************************************/
...
/**********************************************************************
 * 中文字库 24x24点阵 operate functions
 **********************************************************************/
 ...
 *
 * 寻找字库起始位置:
 *   offset=offset = (94 * (qh - 1) + (wh - 1)) * 72L   (72 is from 24*24/8)
 *
 */

#endif /* HAS_CHINESE_FONT */

#endif /* HAS_CHARSET_24 */
