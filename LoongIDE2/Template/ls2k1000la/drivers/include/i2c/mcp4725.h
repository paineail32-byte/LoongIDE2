...
#define ls2k_mcp4725_write(iic, buf, size, arg) ls2k_mcp4725_drv_ops->write_entry(iic, buf, size, arg)
#define ls2k_mcp4725_ioctl(iic, cmd, arg)       ls2k_mcp4725_drv_ops->ioctl_entry(iic, cmd, arg)
