...
#define ls2k_ads1015_read(iic, buf, size, arg)  ls2k_ads1015_drv_ops->read_entry(iic, buf, size, arg)
#define ls2k_ads1015_ioctl(iic, cmd, arg)       ls2k_ads1015_drv_ops->ioctl_entry(iic, cmd, arg)
