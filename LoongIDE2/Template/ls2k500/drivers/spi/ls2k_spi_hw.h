...
#define SPI0_BASE               0x1fd00000
#define SPI1_BASE               0x1fd40000
#define SPI2_BASE               0x1ff50000
#define SPI3_BASE               0x1ff51000
#define SPI4_BASE               0x1ff52000
#define SPI5_BASE               0x1ff53000
...
typedef struct
{
    ...
    union
    {
        volatile unsigned char param;       // 0x04 参数控制寄存器  SPI0~1
        volatile unsigned char cs;          // 0x04 片选寄存器      SPI2~5
    } R4;
