...
void register_all_devices(void)
{
...
#endif
#if BSP_USE_SPI2
    ls2k_spi_initialize(busSPI2);
#endif
#if BSP_USE_SPI3
    ls2k_spi_initialize(busSPI3);
#endif
#if BSP_USE_SPI4
    ls2k_spi_initialize(busSPI4);
#endif
#if BSP_USE_SPI5
    ls2k_spi_initialize(busSPI5);
#endif
     ...
     */
#if W25Q32_DRV
    register_devicefs("spi0.norflash", busSPI0, w25q32_drv_ops, NULL);
#endif
...
#endif
#if BSP_USE_I2C4
    ls2k_i2c_initialize(busI2C4);
#endif
#if BSP_USE_I2C5
    ls2k_i2c_initialize(busI2C5);
#endif
...
#endif
#if BSP_USE_PWM4
    dev_name = ls2k_pwm_get_device_name(devPWM4);
    register_devicefs(dev_name, devPWM4, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM5
    dev_name = ls2k_pwm_get_device_name(devPWM5);
    register_devicefs(dev_name, devPWM5, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM6
    dev_name = ls2k_pwm_get_device_name(devPWM6);
    register_devicefs(dev_name, devPWM6, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM7
    dev_name = ls2k_pwm_get_device_name(devPWM7);
    register_devicefs(dev_name, devPWM7, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM8
    dev_name = ls2k_pwm_get_device_name(devPWM8);
    register_devicefs(dev_name, devPWM8, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM9
    dev_name = ls2k_pwm_get_device_name(devPWM9);
    register_devicefs(dev_name, devPWM9, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM10
    dev_name = ls2k_pwm_get_device_name(devPWM10);
    register_devicefs(dev_name, devPWM10, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM11
    dev_name = ls2k_pwm_get_device_name(devPWM11);
    register_devicefs(dev_name, devPWM11, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM12
    dev_name = ls2k_pwm_get_device_name(devPWM12);
    register_devicefs(dev_name, devPWM12, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM13
    dev_name = ls2k_pwm_get_device_name(devPWM13);
    register_devicefs(dev_name, devPWM13, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM14
    dev_name = ls2k_pwm_get_device_name(devPWM14);
    register_devicefs(dev_name, devPWM14, pwm_drv_ops, NULL);
#endif
#if BSP_USE_PWM15
    dev_name = ls2k_pwm_get_device_name(devPWM15);
    register_devicefs(dev_name, devPWM15, pwm_drv_ops, NULL);
#endif
