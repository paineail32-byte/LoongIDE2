...
#define DMA_CCR_PL_MID			(1<<12)
#define DMA_CCR_PL_HIGH			(2<<12)
#define DMA_CCR_PL_HIGHEST		(3<<12)

#define DMA_CCR_MSIZE_MASK		(0x03<<10)		/* RW bit[11:10] 存储器数据宽度, 该位域由软件配置和清除. */
#define DMA_CCR_MSIZE_SHIFT		10
#define DMA_CCR_MSIZE_8b		(0<<10)
#define DMA_CCR_MSIZE_16b		(1<<10)
#define DMA_CCR_MSIZE_32b		(2<<10)

#define DMA_CCR_PSIZE_MASK		(0x03<<8)		/* RW bit[9:8] 外设数据宽度, 该位域由软件配置和清除. */
#define DMA_CCR_PSIZE_SHIFT		8
#define DMA_CCR_PSIZE_8b		(0<<8)
#define DMA_CCR_PSIZE_16b		(1<<8)
#define DMA_CCR_PSIZE_32b		(2<<8)
 ...
 */
/*
 * 15:0 NDT RW 数据传输个数, 这个寄存器只能通道停用时写入. 通道开启后变为只读, 此时读数为待传输个数.
...
/*
	...
	| I2C   | TX  | RX  |  -  |  -  |
	|-------|-----|-----|-----|-----|
	| ATIM  | CH1 | CH2 | CH3 | CH4 |
	|       | COM | UP  | TRG |  -  |
	|-------|-----|-----|-----|-----|
	| GTIM  | CH1 | CH2 | CH3 | CH4 |
	|       |  -  | UP  |  -  |  -  |
	|-------|-----|-----|-----|-----|
	| BTIM  |  -  |  -  |  -  | UP  |
	|-------|-----|-----|-----|-----|
