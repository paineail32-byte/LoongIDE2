...
#if STACK_PARAM
extern unsigned char _system_stack_start;   // __stack_start;
extern unsigned char _system_stack;         // __stack_end;
...
void rt_hw_board_init(void)     // void bsp_start(void)
{
     ...
     * 堆栈参数
     */
    g_stack_start = (unsigned long)&_system_stack_start;
    g_stack_end   = (unsigned long)&_system_stack;
#endif
