...
#if USE_EXTINT
__attribute__((weak))
void ls2k300_irq_dispatch_IP3(void (*dispatch)(int, void*), uint64_t *stack)
{
    return;
}
...
__attribute__((weak))
void ls2k300_irq_dispatch_IP1(void (*dispatch)(int, void*), uint64_t *stack)
{
    return;
}

__attribute__((weak))
void ls2k300_irq_dispatch_IP0(void (*dispatch)(int, void*), uint64_t *stack)
{
    return;
}
#endif
...
void c_interrupt_handler(uint64_t *stack)
{
    ...
    {
#if USE_EXTINT
        ls2k300_irq_dispatch_IP3(bsp_irq_handler_dispatch, stack);
#endif
    ...
    {
#if USE_EXTINT
        ls2k300_irq_dispatch_IP1(bsp_irq_handler_dispatch, stack);
#endif
    ...
    {
#if USE_EXTINT
        ls2k300_irq_dispatch_IP0(bsp_irq_handler_dispatch, stack);
#endif
