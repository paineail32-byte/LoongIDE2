...
struct rtems_rtl_obj_sect_s
{
    ...
    off_t            offset;      /**< Offset into the object file. Relative to the start of the object file. */
    ...
    void*            base;        /**< The base address of the section in memory. */
...
struct rtems_rtl_obj_s
{
    ...
    const char*          oname;        /**< The object file name. Can be relative. */
    const char*          aname;        /**< The archive name containing the
                                        *   object. NULL means the object is not in a lib */
    off_t                ooffset;      /**< The object offset in the archive. */
    size_t               fsize;        /**< Size of the object file. */
    rtems_chain_control  sections;     /**< The sections of interest in the object file. */
    ...
    void*                text_base;    /**< The base address of the text section in memory. */
    size_t               text_size;     /**< The size of the text section. */
    void*                const_base;   /**< The base address of the const section in memory. */
    void*                eh_base;      /**< The base address of the eh section in memory. */
    size_t               eh_size;      /**< The size of the eh section. */
    void*                data_base;    /**< The base address of the data section in memory. */
    void*                bss_base;     /**< The base address of the bss section in memory. */
    size_t               bss_size;     /**< The size of the bss section. */
    size_t               exec_size;    /**< The amount of executable memory allocated */
    void*                entry;        /**< The entry point of the module. */
    uint32_t             checksum;     /**< The checksum of the text sections. A zero means do not checksum. */
