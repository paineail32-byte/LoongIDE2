...
#define USB_CFG2_USB0_SUSPEND_CONFIG	bit(31)				// R/W 0 USB0端口挂起软件配置位, 高有效
#define USB_CFG2_USB1_SUSPEND_CONFIG	bit(30)				// R/W 0 USB1端口挂起软件配置位, 高有效
#define USB_CFG2_USB0_SUSPEND_SOFTEN	bit(29)				// R/W 1 USB0端口挂起软件配置使能位, 高有效
#define USB_CFG2_USB1_SUSPEND_SOFTEN	bit(28)				// R/W 1 USB1端口挂起软件配置使能位, 高有效
...
#define USB_CFG2_DP1_PULLDOWN			bit(11)				// R/W 0 USB1端口dp端口下拉电阻使能. 1: D+使能; 0: D+关闭
#define USB_CFG2_DM1_PULLDOWN			bit(10)				// R/W 0 USB1端口dm端口下拉电阻使能. 1: D-使能; 0: D-关闭
#define USB_CFG2_DP0_PULLDOWN			bit(9)				// R/W 0 USB0端口dp端口下拉电阻使能. 1: D+使能; 0: D+关闭
#define USB_CFG2_DM0_PULLDOWN			bit(8)				// R/W 0 USB0端口dm端口下拉电阻使能. 1: D-使能; 0: D-关闭
#define USB_CFG2_PHY_CLKSEL				bit(3)				// R/W 1 USB端口参考时钟模式选择位: 0-24MHz参考时钟; 1-20MHz参考时钟.
#define USB_CFG2_USB1_RESETn			bit(1)				// R/W 0 USB1端口复位控制位: 0- 复位有效; 1- 复位撤销.
#define USB_CFG2_USB0_RESETn			bit(0)				// R/W 0 USB0端口复位控制位: 0- 复位有效; 1- 复位撤销.
